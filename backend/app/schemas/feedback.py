...
class FeedbackCreateRequest(BaseModel):
    report_type: str = Field(..., min_length=2, description="Type of incident or review")
    address: str = Field(..., min_length=5, description="Incident geographical location")
    description: str = Field(..., min_length=10, description="Comprehensive report details")
...
class FeedbackResponse(BaseModel):
    ...
    status: str = Field(..., description="Open, Under Investigation, or Resolved status")
