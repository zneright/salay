    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-4 sm:p-6 space-y-6 max-w-7xl mx-auto w-full overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/80 pb-6 w-full max-w-full overflow-hidden">
        <div className="min-w-0 flex-1">
          <div className="flex items-center space-x-3 mb-2 flex-wrap">
            ...
            <h1 className="text-lg sm:text-2xl font-bold font-sans tracking-tight break-words max-w-full text-slate-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full">
        <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl space-y-2">
          ...
          <div className="text-lg sm:text-xl font-bold text-slate-100">ONLINE (v1.0.0)</div>
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl space-y-2">
          ...
          <div className="text-lg sm:text-xl font-bold text-slate-100 truncate">CIVIC_TRANSPARENCY_DB</div>
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl space-y-2">
          ...
          <div className="text-lg sm:text-xl font-bold text-slate-100">llama3-70b</div>
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl space-y-2">
          ...
          <div className="text-lg sm:text-xl font-bold text-emerald-400">81.38% Spent</div>
      ...
      <div className="space-y-4 w-full">
        <h2 className="text-base sm:text-lg font-bold font-sans flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full">
          <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-xl space-y-3 hover:border-slate-700 transition">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] bg-slate-800 text-slate-400 px-2 py-0.5 rounded font-mono">Diagnostic</span>
            </div>
            ...
            <button
              onClick={() => handleQuickRun('coco status')}
              className="w-full bg-slate-800 hover:bg-slate-700 text-slate-200 py-1.5 rounded text-xs font-semibold flex items-center justify-center space-x-1 transition active:scale-95"
            >
          ...
          <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-xl space-y-3 hover:border-slate-700 transition">
            <div className="flex items-center justify-between">
              <span className="font-mono text-xs sm:text-sm font-bold text-purple-400">$ coco cortex</span>
              <span className="text-[10px] bg-purple-500/10 text-purple-400 px-2 py-0.5 rounded border border-purple-500/20 font-mono">Cortex LLM</span>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-xl space-y-3 hover:border-slate-700 transition">
            <div className="flex items-center justify-between">
              <span className="font-mono text-xs sm:text-sm font-bold text-emerald-400">$ coco audit</span>
              <span className="text-[10px] bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded border border-emerald-500/20 font-mono">Audit Report</span>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
