...
export const DocumentProofModal: React.FC<DocumentProofModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-950/80 backdrop-blur-md animate-fade-in text-left">
      <div className="relative w-full max-w-4xl max-h-[90vh] flex flex-col rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-2xl overflow-hidden">
        
        {/* Modal Header */}
        <div className="flex items-center justify-between p-5 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/90 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 font-mono mt-0.5">
                {currentDoc.filename} • Contract ID: {currentDoc.contract_id}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-xl text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-sky-500/5 border-b border-neutral-200 dark:border-neutral-800 shrink-0 text-xs">
          <div className="p-2.5 rounded-xl bg-white dark:bg-neutral-800/80 border border-neutral-200 dark:border-neutral-700">
            <span className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider block">Contract ID</span>
            <div className="flex items-center justify-between font-mono font-semibold text-neutral-900 dark:text-white mt-0.5">
              <span>{currentDoc.contract_id}</span>
              <button onClick={handleCopyContract} className="text-sky-500 hover:underline text-[10px]">
          ...
          <div className="p-2.5 rounded-xl bg-white dark:bg-neutral-800/80 border border-neutral-200 dark:border-neutral-700">
            <span className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider block">Approved Budget (ABC)</span>
            <span className="font-bold text-sky-600 dark:text-sky-400 mt-0.5 block">{currentDoc.abc_budget}</span>
          </div>

          <div className="p-2.5 rounded-xl bg-white dark:bg-neutral-800/80 border border-neutral-200 dark:border-neutral-700">
            <span className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider block">Safety & Compliance</span>
          ...
          <div className="p-2.5 rounded-xl bg-white dark:bg-neutral-800/80 border border-neutral-200 dark:border-neutral-700">
            <span className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider block">Implementing Agency</span>
            <span className="font-semibold text-neutral-800 dark:text-neutral-200 mt-0.5 block truncate">{currentDoc.agency}</span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {snippet && (
            <div className="p-4 rounded-xl bg-sky-50 dark:bg-sky-950/30 border border-sky-200 dark:border-sky-800/50 text-xs text-sky-900 dark:text-sky-200 space-y-1">
          ...
          {activeTab === 'preview' ? (
            <div className="w-full h-[450px] rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-800 bg-neutral-950 flex flex-col">
              <iframe
                src={pdfUrl}
