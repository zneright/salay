...
def create_app() -> FastAPI:
    ...
    for prefix in ["/api/v1", "/v1", "/api"]:
        ...
        app.include_router(projects_router, prefix=prefix, tags=["Public Works"])
        app.include_router(budgets_router, prefix=prefix, tags=["Municipal Budgets"])
        app.include_router(feedback_router, prefix=prefix, tags=["Citizen Reports"])
        app.include_router(ai_router, prefix=prefix, tags=["Cortex AI"])
        app.include_router(cli_router, prefix=prefix, tags=["CoCo CLI Agent"])
